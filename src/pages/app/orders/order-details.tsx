...
export function OrderDetails() {
	return (
		<DialogContent>
			<DialogHeader>
				<DialogTitle>Pedido: kj34lkg3fv</DialogTitle>
				...
				<Table>
					...
					<TableBody>
						...
						<TableRow>
							...
							<TableCell className="text-right">2</TableCell>
							<TableCell className="text-right">R$ 5,90</TableCell>
							<TableCell className="text-right">R$ 11,80</TableCell>
						</TableRow>
					</TableBody>
					<TableFooter>
						<TableRow>
							<TableCell colSpan={3}>Total do pedido</TableCell>
							<TableCell className="text-right">R$ 151,60</TableCell>
						</TableRow>
					</TableFooter>
				</Table>
			</div>
